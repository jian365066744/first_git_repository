...
public class SpringMVCUtils {
	...
	public static final String MSG = "controllerMessage";
	//-- Content Type 定义 --//
	...
	public static HttpSession getSession(boolean isNew) {
		return ((ServletRequestAttributes)RequestContextHolder.getRequestAttributes()).getRequest().getSession(isNew);
	}
	...
	/**
	 * 页面消息提示，对应comm.controllerMsg标签
	 */
	public static void addControllerMsg(String controllerMsg) {
		getRequest().setAttribute(MSG, controllerMsg);
	}
